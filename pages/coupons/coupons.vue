				...
				<view class="wrapper">
					<view class="coupon" v-for="(item, index) in coupons" :key="index" @tap="openDetailModal(item)">
						...
						<view class="d-flex align-items-center justify-content-end" style="height: 80rpx;">
							<view @tap.stop="showSearch =  true" class="font-size-sm text-color-primary mr-10 ">赠送好友</view>
							<view v-if="item.couponType == '2'" class="font-size-sm text-color-primary mr-10 ">升级永久
							</view>
...
<style lang="scss" scoped>
	...
	.coupon-list {
		height: calc(100vh - 80rpx - 120rpx - 20rpx);
		/* #ifdef H5 */
		height: calc(100vh - 80rpx - 120rpx - 100rpx);
		/* #endif */
	}
